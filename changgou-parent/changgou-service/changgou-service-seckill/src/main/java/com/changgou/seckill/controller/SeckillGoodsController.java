...
public class SeckillGoodsController {
    ...
    /**
     * @description: 根据时间和 秒杀商品ID 查询 秒杀商品详情
     * @author: QIXIANG LING
     * @date: 2020/8/4 15:38
     * @param: time 时间
     * @param: id   秒杀商品的id
     ...
     */
    @RequestMapping("/one")
    public Result goodsDetails(String time ,String id){
        SeckillGoods seckillGood = seckillGoodsService.goodsDetails(time ,id);
        return new Result<>(true, StatusCode.OK,"查询秒杀商品详情成功",seckillGood);
    }

    /**
     * @description: 根据时间段查询 秒杀商品列表 ;
     * @author: QIXIANG LING
     * @date: 2020/8/4 11:21
     * @param: key 查询的时间
     * @return: com.changgou.util.Result
    ...
    public Result list(String key){
        List<SeckillGoods> seckillGoodsList = seckillGoodsService.findSeckillGoods(key);
