...
public class SkuController {
    ...
    public Result decrSkuNum(@PathVariable(value = "username" ,required = false)String username){
    ...
    public Result<List<Sku>> findSkuByStatus(@PathVariable(value = "status") String status){
        List<Sku> skuList = skuService.findByStatus(status);
        return new Result<List<Sku>>(true, StatusCode.OK,"成功",skuList);
    }
