...
public class ParaController {
    ...
    public Result getByCategoryId(@PathVariable(value = "id")Integer id){
        // 根据分类id 查询参数信息
        List<Para> listPara = paraService.getByCategoryId(id);
        return new Result(true,StatusCode.OK ,"查询参数列表成功",listPara);
    }
